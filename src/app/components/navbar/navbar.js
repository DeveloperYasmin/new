    ...
    if(typeof window !== 'undefined')
{
  ...
  return (
    ...
    <div className="lg:flex "> 
      ...
      <ul>
        <li><Link  className="p-3" href="/">Home</Link></li>
          <li><Link className="p-3" href="/about">About</Link></li> 
          <li><Link  className="p-3" href="/contact">Contact</Link></li>
          <li><Link  className="p-3" href="/blog">Blog</Link></li> 
          <li><Link  className="p-3" href="/admin">Add Post</Link></li> 
          <li><Link  className="p-3" href="/blog">View Post</Link></li>
